...
"""
This is a Modified version of ryu.ofproto.ofproto_v1_4_parser
We change the pack STRING of OFPFlowMonitorRequest and Reply to 
work with ovs nicira extentions
...
class OFPFlowMonitorRequestBase(OFPMultipartRequest):
    ...
    def _serialize_stats_body(self):
        ...
        msg_pack_into('!IHHHB5x', self.buf,
                      offset, self.monitor_id, self.monitor_flags, self.out_port, 0,  self.table_id)
...
class OFPFlowMonitorRequest(OFPFlowMonitorRequestBase):
    ...
    def __init__(self, datapath, flags=0, monitor_id=0,
                 out_port=0xffff, out_group=ofproto.OFPG_ANY,
