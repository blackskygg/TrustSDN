...
function filter(flows) {
    for (var flow in flows) {
	for (var key in flows[flow]) {
	    if (key != "match" && key != "instructions" && key != "table_id"
		&& key != "priority") {
...
var topo = {
    ...
    add_links: function (links, slist, hlist) {
	...
	//forge links between hosts and switches
